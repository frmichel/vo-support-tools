# This awk script parses the output of lcg-infosites for Storage Elements. It displays columns:
# SE_hostname, available space, used space, total space (in GB), %age of used space
# The last line gives the sum of available, used and total space (in TB)
#
# Usage:
