...
voms-admin --vo=biomed --host voms-biomed.in2p3.fr --port 8443 --nousercert get-certificates \
					'/O=GRID-FR/C=FR/O=CNRS/OU=I3S/CN=Franck Michel' '/C=FR/O=CNRS/CN=GRID2-FR'
